...
// db.all(
//   "SELECT Comments.CommentID, Comments.Name, Comments.Content, Articles.ArticleName, Articles.Date FROM Articles INNER JOIN Comments ON Comments.ArticleID = Articles.ArticleID GROUP BY Comments.CommentID",
//   function (err, rows) {
//     if (err) {
//       console.error(err.message);
//     }
